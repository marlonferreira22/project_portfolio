...
<!--     <div class="title-princial">CADASTRAR PROJETO</div> -->
    ...
    <section class="container">
        <div class="form-control">
			<form:form action="memberinsert" method="post" modelAttribute="project" class="needs-validation">
                <div class="row">
...
<%--                                 <form:input path="name" type="text" class="form-control" id="name" placeholder="Digite nome do projeto" required /> --%>
                    ...
                    <div class="col-md-6 col-xs-6">
                        <div class="form-group">
                            <form:label path="member" for="member" class="form-label">Membro(s)</form:label>
                            <div class="input-group">
                                <span class="input-group-append">
                                    <span class="input-group-text bg-white d-block">
...
<%--                                 <form:input path="manager" class="form-control" list="datalistOptions" id="manager" placeholder="Escolha o Gerente ..." required /> --%>
                                <form:select path="member" items="${memberList}" itemValue="peopleId" itemLabel="name" multiple="true" class="form-select" aria-label="Default select example" placeholder="Selecionar o membro" />
                                <div class="invalid-feedback">
                                    Por favor, selecione o(s) membro(s).
                                </div>
                            </div>
                        </div>
                    </div>    
                ...
                <div class="row">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <form:button class="btn btn-outline-success me-md-2 btn-lg" type="submit" >Salvar</form:button>
                        <button class="btn btn-outline-danger btn-lg" type="reset">Voltar</button>
                      </div>
                </div>
            </form:form>
        </div>
