        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
              ...
              <li><a href="/projectform" class="nav-link px-2 link-secondary">Cadastrar Projeto</a></li>
              <li><a href="#" class="nav-link px-2 link-dark">Assossiar Membro</a></li>
            </ul>
    ...
    <c:set var="beep" value="5"/>
   		<c:if test="${beep == '4'}">
		    ...
		    <div class="alert alert-danger" style="display: flex; justify-content: center;" role="alert">
		        Aconteceu algum problema na criação do seu projeto!!
		    </div>
	    </c:if>
...
<%--             <form:form action="projectregister" method="post" modelAttribute="project" class="needs-validation" novalidate> --%>
			<form:form action="projectregister" method="post" modelAttribute="project" class="needs-validation">
                <div class="row">
...
<%--                                 	<form:select path="risk" items="${riskList}" class="form-select" aria-label="Default select example" placeholder="Selecionar classificação de risco" required /> --%>
                                	<form:select path="risk" items="${riskList}" class="form-select" aria-label="Default select example" placeholder="Selecionar classificação de risco" />
                                <div class="invalid-feedback">
...
<%--                             <form:textarea path="description" class="form-control" id="description" style="height: 150px" required></form:textarea> --%>
                ...
                <div class="row">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <form:button class="btn btn-outline-success me-md-2 btn-lg" type="submit" >Cadastrar</form:button>
