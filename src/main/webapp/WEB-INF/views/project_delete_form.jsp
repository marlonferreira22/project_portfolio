...
<html lang="pt-br">
  <head>
    ...
    <!-- CDNs usadas para chamar o Bootstrap Jquery  -->
    ...
    <c:set var="beep" value="5"/>
   		<c:if test="${beep == '4'}">
		    ...
		    <div class="alert alert-danger" style="display: flex; justify-content: center;" role="alert">
		        Aconteceu algum problema na edição do seu projeto!!
		    </div>
	    </c:if>
...
<!--     <div class="title-princial">CADASTRAR PROJETO</div> -->
    ...
    <section class="container">
        <div class="form-control">
			<form:form action="projectexclude" method="post" modelAttribute="project" class="needs-validation">
                <div class="row">
...
<%--                                 <form:input path="name" type="text" class="form-control" id="name" placeholder="Digite nome do projeto" required /> --%>
                                <form:input path="name" type="text" class="form-control" id="name" placeholder="Digite nome do projeto" readonly="true"/>
                    ...
                    <div class="col-md-6 col-xs-6">
                        <div class="form-group">
                            <form:label path="manager" for="manager" class="form-label">Gerente do Projeto</form:label>
                            <div class="input-group">
                                <span class="input-group-append">
                                    <span class="input-group-text bg-white d-block">
...
<%--                                 <form:input path="manager" class="form-control" list="datalistOptions" id="manager" placeholder="Escolha o Gerente ..." required /> --%>
                                <form:select path="manager" items="${managerList}" itemValue="peopleId" itemLabel="name" class="form-select" aria-label="Default select example" placeholder="Selecionar o gerente" readonly="true"/>
                                <div class="invalid-feedback">
...
<%--                             <form:input path="endPrevisionDate" type="text" class="form-control"  required /> --%>
                            ...
                            <form:input path="endPrevisionDate" type="text" class="form-control" readonly="true"/>
                            <div class="invalid-feedback">
...
<%--                             <form:input path="endDate" type="text" class="form-control"  required /> --%>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-4">
                        <div class="form-group">
                            <form:label path="status"  for="status" class="form-label">Status</form:label>
                            <div class="input-group">
                                <span class="input-group-append">
                                    <span class="input-group-text bg-white d-block">
...
<%--                                 	<form:select path="status" items="${statusList}" class="form-select" aria-label="Default select example" placeholder="Selecionar o status" required /> --%>
									<form:select path="status" items="${statusList}" class="form-select" aria-label="Default select example" placeholder="Selecionar o status" readonly="true"/>
                                <div class="invalid-feedback">
                    ...
                    <div class="col-md-4 col-xs-4">
                        <div class="form-group">
                            <form:label path="budget" class="form-label">Orçamento</form:label>
                            <div class="input-group">
                                <span class="input-group-append">
                                    <span class="input-group-text bg-white d-block">
                                ...
                                <form:input path="budget" type="text" id="budget"  class ="form-control" name="budget"  placeholder="Orçamento do projeto" readonly="true"/>
                                <div class="invalid-feedback">
                    ...
                    <div class="col-md-4 col-xs-4">
                        <div class="form-group">
                            <form:label path="risk" for="risk" class="form-label">Classificação de risco</form:label>
                            <div class="input-group">
                                <span class="input-group-append">
                                    <span class="input-group-text bg-white d-block">
                                        <i class="fa fa-exclamation-triangle"></i>
...
<%--                                 	<form:select path="risk" items="${riskList}" class="form-select" aria-label="Default select example" placeholder="Selecionar classificação de risco" required /> --%>
                                	<form:select path="risk" items="${riskList}" class="form-select" aria-label="Default select example" placeholder="Selecionar classificação de risco" readonly="true"/>
                                <div class="invalid-feedback">
                                    Por favor, insira a classificação do projeto.
                                </div>
                            </div>
                        </div>  
                    </div>
...
<%--                             <form:textarea path="description" class="form-control" id="description" style="height: 150px" required></form:textarea> --%>
                            <form:textarea path="description" class="form-control" id="description" style="height: 150px" readonly="true"></form:textarea>
                            <div class="invalid-feedback">
                ...
                <div class="row">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <form:button class="btn btn-outline-success me-md-2 btn-lg" type="submit" >Deletar</form:button>
                      </div>
                </div>
            </form:form>
        </div>
