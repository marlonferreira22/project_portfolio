...
<!--     <div class="title-princial">CADASTRAR PROJETO</div> -->
    ...
    <section class="container">
        <div class="form-control">
			<form:form action="projectupdate" method="post" modelAttribute="project" class="needs-validation">
                <div class="row">
...
<%--                             <form:textarea path="description" class="form-control" id="description" style="height: 150px" required></form:textarea> --%>
                ...
                <div class="row">
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <form:button class="btn btn-outline-success me-md-2 btn-lg" type="submit" >Editar</form:button>
